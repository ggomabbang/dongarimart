...
export default function recruitCancel() {
  ...
  const submitHandler = async (e) => {
    ...
    const res = await fetch(`/api/admin/recruit/`+ID, {
      method: 'DELETE',
      headers: {
  ...
  return (
    <div className={Styles.Container}>
      <h1 className={Styles.PageTitle}>모집글 삭제하기 (관리자)</h1>
      <div className={Styles.Input}>

        <label className={Styles.HorizonBox}>
          <p className={Styles.Left}>글 ID</p>
